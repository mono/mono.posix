...
MPH_API char* helper_Mono_Posix_readdir (DIR* dir);
...
MPH_API int Mono_Posix_FromStat (struct Mono_Posix_Stat* source, struct stat* destination);
MPH_API int Mono_Posix_FromStatvfs (struct Mono_Posix_Statvfs* source, struct statvfs* destination);
...
MPH_API int Mono_Posix_Stdlib_clearerr (FILE* stream);
MPH_API fpos_t* Mono_Posix_Stdlib_CreateFilePosition ();
...
MPH_API int Mono_Posix_Stdlib_fclose (FILE* stream);
MPH_API int Mono_Posix_Stdlib_feof (FILE* stream);
MPH_API int Mono_Posix_Stdlib_ferror (FILE* stream);
MPH_API int Mono_Posix_Stdlib_fflush (FILE* stream);
MPH_API int Mono_Posix_Stdlib_fgetc (FILE* stream);
MPH_API int Mono_Posix_Stdlib_fgetpos (FILE* stream, void* pos);
MPH_API void* Mono_Posix_Stdlib_fgets (char* sb, int size, FILE* stream);
...
MPH_API int Mono_Posix_Stdlib_fprintf (FILE* stream, const char* format, const char* message);
MPH_API int Mono_Posix_Stdlib_fputc (int c, FILE* stream);
MPH_API int Mono_Posix_Stdlib_fputs (const char* s, FILE* stream);
...
MPH_API void* Mono_Posix_Stdlib_freopen (const char* path, const char* mode, FILE* stream);
MPH_API int Mono_Posix_Stdlib_fseek (FILE* stream, int64_t offset, int origin);
MPH_API int Mono_Posix_Stdlib_fsetpos (FILE* stream, void* pos);
MPH_API int64_t Mono_Posix_Stdlib_ftell (FILE* stream);
...
MPH_API int Mono_Posix_Stdlib_rewind (FILE* stream);
MPH_API int Mono_Posix_Stdlib_setbuf (FILE* stream, char* buf);
MPH_API void Mono_Posix_Stdlib_SetLastError (int error);
MPH_API int Mono_Posix_Stdlib_setvbuf (FILE* stream, void* buf, int mode, uint64_t size);
...
MPH_API int Mono_Posix_Syscall_fgetpwent (FILE* stream, struct Mono_Posix_Syscall__Passwd* pwbuf);
...
MPH_API int Mono_Posix_Syscall_getgrgid_r (unsigned int uid, struct Mono_Posix_Syscall__Group* grbuf, struct group** grbufp);
MPH_API int Mono_Posix_Syscall_getgrnam (const char* name, struct Mono_Posix_Syscall__Group* group);
MPH_API int Mono_Posix_Syscall_getgrnam_r (const char* name, struct Mono_Posix_Syscall__Group* grbuf, struct group** grbufp);
...
MPH_API int Mono_Posix_Syscall_getpwnam_r (const char* name, struct Mono_Posix_Syscall__Passwd* pwbuf, struct passwd** pwbufp);
MPH_API int Mono_Posix_Syscall_getpwuid (unsigned int uid, struct Mono_Posix_Syscall__Passwd* passwd);
MPH_API int Mono_Posix_Syscall_getpwuid_r (unsigned int uid, struct Mono_Posix_Syscall__Passwd* pwbuf, struct passwd** pwbufp);
...
MPH_API int Mono_Posix_Syscall_readdir (DIR* dir, struct Mono_Posix_Syscall__Dirent* dentry);
MPH_API int32_t Mono_Posix_Syscall_readdir_r (DIR* dirp, struct Mono_Posix_Syscall__Dirent* entry, struct dirent** result);
...
MPH_API int32_t Mono_Posix_Syscall_rewinddir (DIR* dir);
MPH_API int Mono_Posix_Syscall_seekdir (DIR* dir, int64_t offset);
...
MPH_API int64_t Mono_Posix_Syscall_telldir (DIR* dir);
...
MPH_API int Mono_Posix_ToStatvfs (struct statvfs* source, struct Mono_Posix_Statvfs* destination);
