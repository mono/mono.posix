...
MPH_API int Mono_Posix_Stdlib_fgetpos (FILE* stream, fpos_t* pos);
MPH_API char* Mono_Posix_Stdlib_fgets (char* sb, int size, FILE* stream);
MPH_API int Mono_Posix_Stdlib_FILENAME_MAX (void);
MPH_API FILE* Mono_Posix_Stdlib_fopen (const char* path, const char* mode);
MPH_API int Mono_Posix_Stdlib_FOPEN_MAX (void);
MPH_API int32_t Mono_Posix_Stdlib_fprintf (FILE* stream, const char* format, const char* message);
MPH_API int Mono_Posix_Stdlib_fputc (int c, FILE* stream);
MPH_API int Mono_Posix_Stdlib_fputs (const char* s, FILE* stream);
MPH_API uint64_t Mono_Posix_Stdlib_fread (unsigned char* ptr, mph_size_t size, mph_size_t nmemb, FILE* stream);
MPH_API void Mono_Posix_Stdlib_free (void* ptr);
MPH_API FILE* Mono_Posix_Stdlib_freopen (const char* path, const char* mode, FILE* stream);
MPH_API int Mono_Posix_Stdlib_fseek (FILE* stream, int64_t offset, int origin);
MPH_API int32_t Mono_Posix_Stdlib_fsetpos (FILE* stream, fpos_t* pos);
MPH_API int64_t Mono_Posix_Stdlib_ftell (FILE* stream);
MPH_API uint64_t Mono_Posix_Stdlib_fwrite (unsigned char* ptr, mph_size_t size, mph_size_t nmemb, FILE* stream);
...
MPH_API int Mono_Posix_Stdlib_setvbuf (FILE* stream, char* buf, int mode, mph_size_t size);
