// NOTE: file hand-edited to remove warnings use standard types. DO NOT regenerated until create-native-map is modified
// to generate sources in the shape and form we want.
...
MPH_API int Mono_Posix_FromMountFlags (uint64_t x, uint64_t *r);
MPH_API int Mono_Posix_ToMountFlags (uint64_t x, uint64_t *r);
...
struct Mono_Posix_Cmsghdr {
	int64_t cmsg_len; //  FIXME: struct cmsghdr uses `size_t`
	int    cmsg_level;
	int    cmsg_type;
};
...
struct Mono_Posix_Stat {
	...
	int64_t       st_atime_;      /* time_t    */
	int64_t       st_mtime_;      /* time_t    */
	int64_t       st_ctime_;      /* time_t    */
...
struct Mono_Posix_Statvfs {
	uint64_t f_bsize;
	uint64_t f_frsize;
	uint64_t f_blocks;   /* fsblkcnt_t */
	uint64_t f_bfree;    /* fsblkcnt_t */
	uint64_t f_bavail;   /* fsblkcnt_t */
	uint64_t f_files;    /* fsfilcnt_t */
	uint64_t f_ffree;    /* fsfilcnt_t */
	uint64_t f_favail;   /* fsfilcnt_t */
	uint64_t f_fsid;
	uint64_t f_flag;
	uint64_t f_namemax;
};
...
struct Mono_Posix_Utimbuf {
	int64_t actime;   /* time_t */
	int64_t modtime;  /* time_t */
};
...
MPH_API int helper_Mono_Posix_Stat (const char* filename, int dereference, int* device, int* inode, int* mode, int* nlinks, int* uid, int* gid, int* rdev, int64_t* size, int64_t* blksize, int64_t* blocks, int64_t* atime, int64_t* mtime, int64_t* ctime);
...
MPH_API int Mono_Posix_Sockaddr_GetNativeSize (struct Mono_Posix__SockaddrHeader* address, int64_t* size);
MPH_API int Mono_Posix_Stdlib_BUFSIZ (void);
MPH_API void* Mono_Posix_Stdlib_calloc (uint64_t nmemb, uint64_t size);
...
MPH_API uint64_t Mono_Posix_Stdlib_fread (unsigned char* ptr, uint64_t size, uint64_t nmemb, void* stream);
...
MPH_API int Mono_Posix_Stdlib_fseek (void* stream, int64_t offset, int origin);
MPH_API int Mono_Posix_Stdlib_fsetpos (void* stream, void* pos);
MPH_API int64_t Mono_Posix_Stdlib_ftell (void* stream);
MPH_API uint64_t Mono_Posix_Stdlib_fwrite (unsigned char* ptr, uint64_t size, uint64_t nmemb, void* stream);
...
MPH_API void* Mono_Posix_Stdlib_malloc (uint64_t size);
...
MPH_API void* Mono_Posix_Stdlib_realloc (void* ptr, uint64_t size);
...
MPH_API int Mono_Posix_Stdlib_setvbuf (void* stream, void* buf, int mode, uint64_t size);
...
MPH_API uint64_t Mono_Posix_Syscall_CMSG_ALIGN (uint64_t length);
MPH_API int64_t Mono_Posix_Syscall_CMSG_DATA (unsigned char* msg_control, int64_t msg_controllen, int64_t cmsg);
MPH_API int64_t Mono_Posix_Syscall_CMSG_FIRSTHDR (unsigned char* msg_control, int64_t msg_controllen);
MPH_API uint64_t Mono_Posix_Syscall_CMSG_LEN (uint64_t length);
MPH_API int64_t Mono_Posix_Syscall_CMSG_NXTHDR (unsigned char* msg_control, int64_t msg_controllen, int64_t cmsg);
MPH_API uint64_t Mono_Posix_Syscall_CMSG_SPACE (uint64_t length);
MPH_API uint64_t Mono_Posix_Syscall_confstr (int name, char* buf, uint64_t len);
...
MPH_API int Mono_Posix_Syscall_fcntl_arg (int fd, int cmd, int64_t arg);
...
MPH_API int64_t Mono_Posix_Syscall_fgetxattr (int fd, const char* name, unsigned char* value, uint64_t size);
MPH_API int64_t Mono_Posix_Syscall_flistxattr (int fd, unsigned char* list, uint64_t size);
MPH_API int64_t Mono_Posix_Syscall_fpathconf (int filedes, int name, int defaultError);
MPH_API int Mono_Posix_Syscall_fremovexattr (int fd, const char* name);
MPH_API int Mono_Posix_Syscall_fsetxattr (int fd, const char* name, unsigned char* value, uint64_t size, int flags);
...
MPH_API int Mono_Posix_Syscall_ftruncate (int fd, int64_t length);
...
MPH_API void* Mono_Posix_Syscall_getcwd (char* buf, uint64_t size);
MPH_API int Mono_Posix_Syscall_getdomainname (char* name, uint64_t len);
...
MPH_API int64_t Mono_Posix_Syscall_gethostid (void);
MPH_API int Mono_Posix_Syscall_gethostname (char* name, uint64_t len);
MPH_API int Mono_Posix_Syscall_getlogin_r (char* name, uint64_t bufsize);
...
MPH_API int64_t Mono_Posix_Syscall_get_utime_omit (void);
MPH_API int64_t Mono_Posix_Syscall_lgetxattr (const char* path, const char* name, unsigned char* value, uint64_t size);
MPH_API int64_t Mono_Posix_Syscall_listxattr (const char* path, unsigned char* list, uint64_t size);
MPH_API int64_t Mono_Posix_Syscall_llistxattr (const char* path, unsigned char* list, uint64_t size);
MPH_API int Mono_Posix_Syscall_lockf (int fd, int cmd, int64_t len);
MPH_API int Mono_Posix_Syscall_lremovexattr (const char* path, const char* name);
MPH_API int64_t Mono_Posix_Syscall_lseek (int fd, int64_t offset, int whence);
MPH_API int Mono_Posix_Syscall_lsetxattr (const char* path, const char* name, unsigned char* value, uint64_t size, int flags);
...
MPH_API int Mono_Posix_Syscall_mincore (void* start, uint64_t length, unsigned char* vec);
MPH_API int Mono_Posix_Syscall_mknod (const char* pathname, unsigned int mode, uint64_t dev);
MPH_API int Mono_Posix_Syscall_mknodat (int dirfd, const char* pathname, unsigned int mode, uint64_t dev);
MPH_API int Mono_Posix_Syscall_mlock (void* start, uint64_t len);
MPH_API void* Mono_Posix_Syscall_mmap (void* start, uint64_t length, int prot, int flags, int fd, int64_t offset);
MPH_API int Mono_Posix_Syscall_mprotect (void* start, uint64_t len, int prot);
MPH_API void* Mono_Posix_Syscall_mremap (void* old_address, uint64_t old_size, uint64_t new_size, uint64_t flags);
MPH_API int Mono_Posix_Syscall_msync (void* start, uint64_t len, int flags);
MPH_API int Mono_Posix_Syscall_munlock (void* start, uint64_t len);
...
MPH_API int Mono_Posix_Syscall_posix_fadvise (int fd, int64_t offset, int64_t len, int advice);
MPH_API int Mono_Posix_Syscall_posix_fallocate (int fd, int64_t offset, uint64_t len);
MPH_API int Mono_Posix_Syscall_posix_madvise (void* addr, uint64_t len, int advice);
MPH_API int64_t Mono_Posix_Syscall_pread (int fd, void* buf, uint64_t count, int64_t offset);
MPH_API int64_t Mono_Posix_Syscall_preadv (int fd, struct Mono_Posix_Iovec* iov, int iovcnt, int64_t offset);
MPH_API int Mono_Posix_Syscall_psignal (int sig, const char* s);
MPH_API int64_t Mono_Posix_Syscall_pwrite (int fd, void* buf, uint64_t count, int64_t offset);
MPH_API int64_t Mono_Posix_Syscall_pwritev (int fd, struct Mono_Posix_Iovec* iov, int iovcnt, int64_t offset);
MPH_API int64_t Mono_Posix_Syscall_read (int fd, void* buf, uint64_t count);
...
MPH_API int64_t Mono_Posix_Syscall_readlink (const char* path, unsigned char* buf, uint64_t bufsiz);
MPH_API int64_t Mono_Posix_Syscall_readlinkat (int dirfd, const char* pathname, unsigned char* buf, uint64_t bufsiz);
MPH_API int64_t Mono_Posix_Syscall_readv (int fd, struct Mono_Posix_Iovec* iov, int iovcnt);
MPH_API int64_t Mono_Posix_Syscall_recv (int socket, void* buffer, uint64_t length, int flags);
MPH_API int64_t Mono_Posix_Syscall_recvfrom (int socket, void* buffer, uint64_t length, int flags, struct Mono_Posix__SockaddrHeader* address);
MPH_API int64_t Mono_Posix_Syscall_recvmsg (int socket, struct Mono_Posix_Syscall__Msghdr* message, struct Mono_Posix__SockaddrHeader* msg_name, int flags);
MPH_API int Mono_Posix_Syscall_remap_file_pages (void* start, uint64_t size, int prot, int64_t pgoff, int flags);
...
MPH_API int Mono_Posix_Syscall_seekdir (void* dir, int64_t offset);
MPH_API int64_t Mono_Posix_Syscall_send (int socket, void* message, uint64_t length, int flags);
MPH_API int64_t Mono_Posix_Syscall_sendfile (int out_fd, int in_fd, int64_t* offset, uint64_t count);
MPH_API int64_t Mono_Posix_Syscall_sendmsg (int socket, struct Mono_Posix_Syscall__Msghdr* message, struct Mono_Posix__SockaddrHeader* msg_name, int flags);
MPH_API int64_t Mono_Posix_Syscall_sendto (int socket, void* message, uint64_t length, int flags, struct Mono_Posix__SockaddrHeader* address);
MPH_API int Mono_Posix_Syscall_setdomainname (const char* name, uint64_t len);
MPH_API int Mono_Posix_Syscall_setfsent (void);
MPH_API int Mono_Posix_Syscall_setgrent (void);
MPH_API int Mono_Posix_Syscall_setgroups (uint64_t size, unsigned int* list);
MPH_API int Mono_Posix_Syscall_sethostid (int64_t hostid);
MPH_API int Mono_Posix_Syscall_sethostname (const char* name, uint64_t len);
MPH_API int Mono_Posix_Syscall_setpwent (void);
MPH_API int Mono_Posix_Syscall_setsockopt (int socket, int level, int option_name, void* option_value, int64_t option_len);
...
MPH_API int Mono_Posix_Syscall_setxattr (const char* path, const char* name, unsigned char* value, uint64_t size, int flags);
...
MPH_API int64_t Mono_Posix_Syscall_sysconf (int name, int defaultError);
MPH_API int Mono_Posix_Syscall_syslog (int priority, const char* message);
MPH_API int64_t Mono_Posix_Syscall_telldir (void* dir);
MPH_API int64_t Mono_Posix_Syscall_time (int64_t* t);
MPH_API int Mono_Posix_Syscall_truncate (const char* path, int64_t length);
MPH_API int Mono_Posix_Syscall_ttyname_r (int fd, char* buf, uint64_t buflen);
...
MPH_API int64_t Mono_Posix_Syscall_write (int fd, void* buf, uint64_t count);
